...
export default function PopUpCard(idAtual){
    ...
    return(
        ...
        <button className="border w-full rounded-md h-14 bg-zinc-800 hover:bg-zinc-900 text-white drop-shadow-md mb-4" onClick={alterarValoresCard(setId)}>Confirmar</button>
        </div>
    );
}